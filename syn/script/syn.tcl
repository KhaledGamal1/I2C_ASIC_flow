...
#######################################################################
	# --------------- Reports ------------- #
#######################################################################
report_clocks -attributes  						> ../results/$corner/reports/clocks.rpt
report_area -hierarchy 							> ../results/$corner/reports/synth_area.rpt
report_cell 								> ../results/$corner/reports/synth_cells.rpt
report_qor 								> ../results/$corner/reports/synth_qor.rpt
report_power -hierarchy   						> ../results/$corner/reports/synth_power.rpt
report_timing -delay_type max -max_path 10 				> ../results/$corner/reports/synth_timing_setup.rpt
report_timing -delay_type max -slack_lesser_than 0 -max_paths 2 	> ../results/$corner/reports/synth_timing_setup_violated.rpt
report_timing -delay_type min -max_paths 10 				> ../results/$corner/reports/synth_timing_hold.rpt	
