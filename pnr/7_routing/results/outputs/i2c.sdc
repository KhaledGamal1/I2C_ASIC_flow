################################################################################
#
# Design name:  i2c_routing
#
# Created by icc2 write_sdc on Sun Sep 20 00:57:34 2026
#
################################################################################
...
# -origin user
set_clock_latency -min 0.785351 [get_clocks {wb_clk_i}]
# -origin user
set_clock_latency -max 0.820999 [get_clocks {wb_clk_i}]
...
set_clock_transition 0.249292 [get_clocks {wb_clk_i}]
# /mnt/hgfs/Shared_files/i2c/syn/results/worst/outputs/i2c_master_top.sdc, line \
#   31
