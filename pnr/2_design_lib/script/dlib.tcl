...
######################################################################################
	# ------------------ Read Netlist ------------------ #
######################################################################################
read_verilog -top ${top_module} ${project_dir}/syn/results/$corner/outputs/${top_module}.v
link_block;      # Links the Netlist with the NDM

######################################################################################
	# ------------------ Read SDC ------------------ #
######################################################################################
read_sdc ${project_dir}/syn/results/$corner/outputs/${top_module}.sdc
...
save_block -as ${design}_dlib ${design}.dlib:${top_module}.design
